...
""" models_iosxr.py - Parse, Query, Build, and Modify IOS-style configurations
...
class IOSXRCfgLine(BaseCfgLine):
    ...
    Args:
        - text (str): A string containing a text copy of the IOSXR configuration line.  :class:`~ciscoconfparse.CiscoConfParse` will automatically identify the parent and children (if any) when it parses the configuration. 
        - comment_delimiter (str): A string which is considered a comment for the configuration format.  Since this is for Cisco IOSXR-style configurations, it defaults to ``!``.

    Attributes:
        - text     (str): A string containing the parsed IOSXR configuration statement
        - linenum  (int): The line number of this configuration statement in the original config; default is -1 when first initialized.
        - parent (:class:`~models_iosxr.IOSXRCfgLine()`): The parent of this object; defaults to ``self``.
        - children (list): A list of ``IOSXRCfgLine()`` objects which are children of this object.
    ...
    def __init__(self, *args, **kwargs):
        ...
        attributes"""
        super(IOSXRCfgLine, self).__init__(*args, **kwargs)
    ...
    def is_intf(self):
        ...
        :class:`~models_iosxr.IOSCfgLine` is an interface; subinterfaces
        also return True.
        ...
        .. code-block:: python
           ...
           >>> obj = parse.find_objects('^interface\sGig')[0]
           >>> obj.is_intf
           True
           >>> obj = parse.find_objects('^interface\sBundle')[0]
           >>> obj.is_intf
           True
           >>>
        """
    ...
    def is_subintf(self):
        """Returns a boolean (True or False) to answer whether this 
        :class:`~models_iosxr.IOSXRCfgLine` is a subinterface.
        ...
        .. code-block:: python
           ...
           >>> obj.is_subintf
           False
           >>> obj = parse.find_objects(r'^interface\sGiga')[0]
           >>> obj.is_subintf
           True
           >>>
        """
    ...
    _VIRTUAL_INTF_REGEX_STR = r"""^interface\s+(Loopback|Vlan|Tunnel|Dialer|Virtual-Template|Bundle-Ether)"""
    ...
    def is_loopback_intf(self):
        """Returns a boolean (True or False) to answer whether this 
        :class:`~models_iosxr.IOSXRCfgLine` is a loopback interface.
    ...
    def is_ethernet_intf(self):
        """Returns a boolean (True or False) to answer whether this 
        :class:`~models_iosxr.IOSXRCfgLine` is an ethernet interface.
        Any ethernet interface (10M through 100G) is considered an ethernet
        interface.
    ...
    @property 
    def intf_in_lag(self):
        """Alias for intf_in_portchannel.  More device agnostic.

        """
        return self.intf_in_portchannel
    ...
    def intf_in_portchannel(self):
        ...
        retval = self.re_match_iter_typed(
            r'^\s*bundle\sid\s+(\d+)', result_type=bool, default=False)
        return retval

    @property
    def lag_number(self):
        """Alias for portchannel_number. More device agnostic

        """
        return self.portchannel_number
    ...
    def portchannel_number(self):
        ...
        """
        retval = self.re_match_iter_typed(
            r'^\s*bundle id\s+(\d+)', result_type=int, default=-1)
        return retval

    @property
    def is_lag_intf(self):
        """Alias for is_portchannel_intf. More device agnostic

        """
        return self.is_portchannel_intf
    ...
    def is_portchannel_intf(self):
        ...
        """
        return ('bundle' in self.name.lower())
...
class BaseIOSIntfLine(IOSCfgLine):
    ...
    def manual_mtu(self):
        ...
        :class:`~models_iosxr.IOSIntfLine` object.  Interfaces without a
    ...
    def in_ipv4_subnet(self, ipv4network=IPv4Obj('0.0.0.0/32', strict=False)):
        ...
        Kwargs:
           - ipv4network (:class:`~ccp_util.IPv4Obj`): An object to compare against IP addresses configured on this :class:`~models_iosxr.IOSIntfLine` object.
...
class IOSIntfLine(BaseIOSIntfLine):
    def __init__(self, *args, **kwargs):
        ...
        .. warning::
          ...
          All :class:`~models_iosxr.IOSIntfLine` methods are still considered beta-quality, until this notice is removed.  The behavior of APIs on this object could change at any time.
        """
